...
- `dialog.confirmation.variant.confirm`: Define the title color for the variant confirm.
- `dialog.confirmation.variant.critical`: Define the title color for the variant critical.
