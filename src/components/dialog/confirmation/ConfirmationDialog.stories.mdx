...
- `dialog.confirmation.button.variant.confirm`: Define the button color for the variant confirm.
- `dialog.confirmation.button.variant.critical`: Define the button color for the variant critical.
