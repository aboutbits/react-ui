...
With the menu component it is easy to implement a language picker. Such a new component detects the default languages of a browser and changes it to English if needed.
It also allows the user to switch between the provided languages.

The following package is required for the implementation: [@aboutbits/internationalization](https://www.npmjs.com/package/@aboutbits/internationalization)
