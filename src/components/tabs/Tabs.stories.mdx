...
export const TemplateWithButtons = (args) => {
  ...
  return (
    <Tabs activeName={activeTab} onChange={setActiveTab} {...args}>
...
- `tabs.tabs.base`: Define the base style of the tabs container.
- `tabs.tab.base`: Define the base style of a tab.
- `tabs.tab.normal`: Define the normal style of a tab.
- `tabs.tab.selected`: Define the selected style of a tab.
