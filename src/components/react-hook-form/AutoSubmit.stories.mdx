...
<Meta
  title="Components/React Hook Form/AutoSubmit"
...
It requires to be inside a `React Hook Form` context, i.e [Form](/docs/components-form-form--docs) component.
