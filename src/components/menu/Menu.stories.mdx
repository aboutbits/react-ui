...
- `menu.menuButton.base`: Define the styles for the menu button.
- `menu.menuButton.icon.base`: Define the styles for the icon.
- `menu.menuList.base`: Define the styles for the menu list.
