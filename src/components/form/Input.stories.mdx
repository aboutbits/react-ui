...
In addition, `form.input`, `form.inputLabel` and `form.inputError` can be configured with the following settings for the given variant:

- `form[$component].modeVariant.light[$variant].base`: Defines the base styles of the input in light mode
- `form[$component].modeVariant.light[$variant].normal`: Defines the normal styles of the input in light mode, they will be replaced in error or disabled states
- `form[$component].modeVariant.light[$variant].error`: Defines the error styles of the input in light mode.
- `form[$component].modeVariant.light[$variant].disabled`: Defines the disabled styles of the input in light mode.
- `form[$component].modeVariant.dark[$variant].base`: Defines the base styles of the input in dark mode
- `form[$component].modeVariant.dark[$variant].normal`: Defines the normal styles of the input in dark mode, they will be replaced in error or disabled states
- `form[$component].modeVariant.dark[$variant].error`: Defines the error styles of the input in dark mode.
- `form[$component].modeVariant.dark[$variant].disabled`: Defines the disabled styles of the input in dark mode.
