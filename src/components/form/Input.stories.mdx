...
- `form.input.light.normal`: Defines the normal styles of the input in light mode, they will be replaced in error or disabled states
- `form.input.light.error`: Defines the error styles of the input in light mode.
- `form.input.light.disabled`: Defines the disabled styles of the input in light mode.
- `form.input.dark.normal`: Defines the normal styles of the input in dark mode, they will be replaced in error or disabled states
- `form.input.dark.error`: Defines the error styles of the input in dark mode.
- `form.input.dark.disabled`: Defines the disabled styles of the input in dark mode.
