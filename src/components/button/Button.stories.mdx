...
- `button.button.icon.base`: Define the base styles for the icon.
- `button.button.icon.size.sm`: Define the size of the small size icon.
- `button.button.icon.size.md`: Define the size of the small medium icon.
- `button.button.icon.size.lg`: Define the size of the small large icon.
- `button.button.icon.iconStart.size.sm`: Define the size of the small size start icon.
- `button.button.icon.iconStart.size.md`: Define the size of the medium size start icon.
- `button.button.icon.iconStart.size.lg`: Define the size of the large size start icon.
