...
export const Single: Story = {
  render: ({ autoUpload }) => {
    return <SingeFileRender autoUpload={autoUpload} shouldFail={false} />
  },
}

export const SingleFail: Story = {
  render: ({ autoUpload }) => {
    return <SingeFileRender autoUpload={autoUpload} shouldFail={true} />
  },
}
...
function RenderMultiple({
  ...
  const { remoteFiles, mutateRemoteFiles, axiosInstance } = useMockedUploadApi({
    multipleFiles: true,
    initialFiles: [
...
export const Multiple: Story = {
  render: ({ autoUpload }) => {
    return <RenderMultiple autoUpload={autoUpload} shouldFail={false} />
  },
}

export const MultipleFail: Story = {
  render: ({ autoUpload }) => {
    return <RenderMultiple autoUpload={autoUpload} shouldFail={true} />
  },
}
