...
export const DissmissCriticalButton = (
  <Button variant={Variant.transparent} size={Size.sm} tone={Tone.critical}>
    Dismiss
  </Button>
)
...
- `alert.content.base`: Defines base styles of the content (title, message, actions)
- `alert.content.actionsPositions.responsive`: Defines styles of the actions when they should be responsive
- `alert.content.actionsPositions.fixedRight`: Defines styles of the actions when they should be fixed to the right
- `alert.content.actionsPositions.fixedBottom`: Defines styles of the actions when they should be fixed to the bottom
- `alert.texts.base`: Defines base styles of the texts (title, message)
- `alert.title.base`: Defines base styles of the title
- `alert.message.base`: Defines base styles of the message
- `alert.actions.base`: Defines base styles of the actions
