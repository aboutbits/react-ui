...
import { InputVariant, Status } from './types'

<Meta title="Components/FormNew/InputField" component={InputField} />
...
export const Template = ({ ...args }) => <InputField {...args} name="name" />
