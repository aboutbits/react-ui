 ...
 * A checkbox field.
 *
 * Is composed of the primitives [Checkbox](../?path=/docs/components-formnew-primitive-checkbox--default-stroy) and [InputMessage](../?path=/docs/components-formnew-primitive-inputmessage--default-story).
 */
