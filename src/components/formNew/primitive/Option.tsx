...
import { ModeProps, Mode } from '../../types'
...
/**
 * A custom themed `option` element to be used with [Select](../?path=/docs/components-formnew-primitive-select--default-story).
 */
