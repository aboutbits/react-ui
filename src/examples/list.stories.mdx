      ...
      <SectionHeaderArea>
        ...
        >
          <SectionHeaderRow layout={SectionHeaderRowLayout.stretch}>
            ...
            >
              <SearchFormField className="w-full md:w-auto grow" />
              <SectionHeaderGroup className="grid grid-cols-2 w-full md:block md:flex md:w-auto">
                <SelectFormField name="role" variant={filterVariant}>
      ...
      >
        <SectionHeaderArea>
          <SectionHeaderRow
            layout={
              isScreenMedium
                ? SectionHeaderRowLayout.spaceBetween
...
export const TemplateListWithFilterDialog = ({
  ...
  const Filters = () => (
    <>
      <SelectFormField id="role" name="role" variant={FormVariant.transparent}>
        <Option value="">All roles</Option>
        <Option value="ADMIN">Admin</Option>
        <Option value="USER">User</Option>
      </SelectFormField>
      ...
      <SearchFormField className="col-span-full" />
    </>
  )
  return (
    <>
