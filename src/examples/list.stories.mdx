          ...
          <SectionContentList>
            {content.length > 0 &&
              content
                ...
                .map((item) => (
                  <SectionListItemWithButton key={item}>
                    {`User ${item + 1}`}
                  </SectionListItemWithButton>
                ))}
            {content.length === 0 && (
...
[Section](/docs/components-section-section--default-story): Defines the overall container.

[SectionHeader](/docs/components-section-SectionHeader--default-story): Defines the header of the list.

[SectionTitle](/docs/components-section-SectionTitle--default-story): Defines the title of the list.

[SectionContentList](/docs/components-section-SectionContentList--default-story): Defines the container for the list.

[SectionListItemWithButton](/docs/components-section-SectionListItemWithButton--default-story): Defines each list item.

[SectionContentListEmpty](/docs/components-section-SectionContentListEmpty--default-story): Defines the placeholder if no input was given.

[PaginationInMemory](/docs/components-pagination-paginationinmemory--default-story): Defines the pagination of the example.
