    ...
    <Section>
      <SectionHeader>
        ...
        <SectionFilter
          ...
          className="flex flex-wrap lg:flex-nowrap order-last lg:order-none w-full lg:w-auto"
        >
          ...
          <SectionSearch className="w-full lg:w-auto" />
        </SectionFilter>
        <SectionActions>
    ...
    <>
      {isDialogEnabled && dialogShow && (
        <Dialog
          ...
          aria-label="Filter"
          className="md:my-20 mx-auto md:w-full md:max-w-3xl bg-white md:bg-transparent md:rounded-md overflow-hidden"
        >
          ...
          <SectionFilter
            ...
            className="px-4 lg:px-5 py-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 bg-white border-b border-neutral-500"
          >
            <Filters />
            <SubmitButton className="col-span-full">Apply filter</SubmitButton>
          </SectionFilter>
        </Dialog>
      )}
      <Section>
