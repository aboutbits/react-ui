...
import { DialogHeaderClose } from '../components/dialog/DialogHeaderClose'
import {
  Section,
  SectionTitle,
  SectionContainer,
...
import { SectionContentMessage } from '../components/section/Section/SectionContentMessage'
    ...
    <>
      {isDialogEnabled && dialogShow && (
        ...
        >
          ...
          >
            <DialogContentArea className="flex flex-col gap-y-2">
              <Filters />
            </DialogContentArea>
            <DialogFooterArea>
              <DialogFooterActions>
