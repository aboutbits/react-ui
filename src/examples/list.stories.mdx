...
export const TemplateDefault = ({
  ...
  return (
    <Section>
      <SectionHeader increasedBottomSpacing>
        <SectionHeaderRow>
        ...
        >
          <SectionHeaderRow layout={SectionHeaderRowLayout.full}>
            ...
            >
              ...
              <SectionHeaderGroup className="flex-wrap md:flex-nowrap w-full md:w-auto">
                <Select id="role" name="role" variant={InputVariant.underline}>
